            ...
            <Table aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className={classes.tableHead} align="right">จำนวน</TableCell>
                  <TableCell className={classes.tableHead} align="right">เพิ่มขึ้น</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {rows.map((row) => (
                  <TableRow key={row.product_name}>
                    ...
                    <TableCell style={{color:"rgba(50,50,50,0.8)"}} align="right">{row.amount}</TableCell>
                    <TableCell className={classes.dataPercentage}align="right">{row.value}%</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
